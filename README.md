...
- Version 0.8: calling connvetion changed from stdcall to cdecl to avoid name decorations. Delphi files adjusted. Bug when executing filters using preview with ColBytes = 1 (corrected, will be available in next version).
